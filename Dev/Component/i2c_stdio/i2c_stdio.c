...
void I2C_Prime_Transmit(i2c_stdio_typedef* p_i2c)
{
	...
	// LL_I2C_EnableIT_ADDR(p_i2c->handle);
	LL_I2C_EnableIT_TC(p_i2c->handle);
	LL_I2C_EnableIT_STOP(p_i2c->handle);
	// LL_I2C_EnableIT_NACK(p_i2c->handle);
...
void I2C_ER_IRQHandler(i2c_stdio_typedef* p_i2c)
{
	...
	// LL_I2C_DisableIT_EVT(p_i2c->handle);
	LL_I2C_DisableIT_ERR(p_i2c->handle);
//	LL_I2C_DisableIT_ADDR(p_i2c->handle);
	LL_I2C_DisableIT_TC(p_i2c->handle);
	LL_I2C_DisableIT_STOP(p_i2c->handle);
	// LL_I2C_DisableIT_NACK(p_i2c->handle);
